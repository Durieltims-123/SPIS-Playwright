...
export class LoginPage {
    ...
    async goto() {
        await this.page.goto('http://172.31.208.231/spis-testing', { waitUntil: 'domcontentloaded' });
    }
    ...
    async validateUsernameError(password: string) {
        await expect(this.page.locator('div[id="swal2-content"]')).toContainText('Username does not yet exist.')
    }
